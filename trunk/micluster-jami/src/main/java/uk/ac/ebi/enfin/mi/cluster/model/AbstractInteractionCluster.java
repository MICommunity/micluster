...
import uk.ac.ebi.enfin.mi.cluster.bridge.PsicquicService;
...
public abstract class AbstractInteractionCluster<T extends EncoreBinaryInteraction> implements BinaryInteractionCluster<T> {
    ...
    protected Iterator<BinaryInteractionCluster> binaryInteractionIterator;

    public AbstractInteractionCluster(List<BinaryInteractionCluster> binaryInteractionList, String mappingIdDbNames){
    ...
    public AbstractInteractionCluster(List<BinaryInteractionCluster> binaryInteractionList){
        String [] dbNames;

...
public class InteractionCluster extends AbstractInteractionCluster<EncoreInteraction> {
    ...
    protected ClusterComparator comparator = new DefaultClusterComparator();
    ...
    @Override
    protected EncoreInteraction convertEncoreInteractionFrom(BinaryInteractionCluster binaryInteraction, String[] strings) {
    ...
    public void saveResultsInMitab(String fileName) throws IOException {
        ...
        try{
            ...
            for(Integer mappingId:interactionMapping.keySet()){
                ...
                BinaryInteractionCluster bI = iConverter.getBinaryInteractionForScoring(eI);

                //TODO: I have to use JAMI to save the results in Mitab
    ...
    public ClusterComparator getComparator() {
        return comparator;
    }

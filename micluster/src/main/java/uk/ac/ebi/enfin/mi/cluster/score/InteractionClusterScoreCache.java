 ...
 */
public class InteractionClusterScoreCache {
    private static final Logger logger = Logger.getLogger(InteractionClusterScoreCache.class);
    ...
    public InteractionClusterScoreCache(){
        getMITermsFromOLS();
    }

...
public abstract class AbstractEncoreInteraction implements EncoreBinaryInteraction {
    ...
    //NEW
    protected InteractorCluster A = new InteractorCluster();
    protected InteractorCluster B = new InteractorCluster();
    ...
    public String getInteractorA(String mappingIdDbNames) {
        ...
        String acc = getInteractorFromAccs(this.A.getAcs(), mappingIdDbNames.split(","));
        return acc;
    }
    ...
    public List<CrossReference> getOrganismsA() {
        return this.A.getOrganisms();
    }

    public void setOrganismsA(List<CrossReference> organismsA) {
        this.A.setOrganisms(organismsA);
    }
    ...
    public void addOrganismA(CrossReference organismA) {
        if(!this.A.getOrganisms().contains(organismA)){
            this.A.getOrganisms().add(organismA);
        }
    }

    public List<CrossReference> getOrganismsB() {
        return this.B.getOrganisms();
    }

    public void setOrganismsB(List<CrossReference> organismsB) {
        this.B.setOrganisms(organismsB);
    }
    ...
    public void addOrganismB(CrossReference organismB) {
        if(!this.B.getOrganisms().contains(organismB)){
            this.B.getOrganisms().add(organismB);
        }
    }
